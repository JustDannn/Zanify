...
<div
    class="w-[200px] h-full flex-shrink-0 cursor-pointer p-4 bg-white/5 hover:bg-amber-50/35 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 rounded-2xl transition duration-300 relative group">
    ...
    <div class="relative w-full aspect-square mb-3 overflow-hidden rounded-lg shadow-xl">
        ...
        <div
            class="absolute bottom-2 right-2 opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition duration-300 ease-in-out">
        ...
        <div class="absolute bottom-1 right-2 p-1">
            <span class="text-white font-black text-2xl" style="text-shadow: 2px 2px 4px #000000;">{{ $mixNumber
                }}</span>
        </div>
    </div>

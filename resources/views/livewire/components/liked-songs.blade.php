<div class="min-h-screen bg-linear-to-b from-[#5038a0] to-[#121212]">
    {{-- Header --}}
    <div class="px-6 pt-16 pb-8">
        <div class="flex items-end gap-6">
            {{-- Liked Songs Cover --}}
            <div
                class="w-56 h-56 bg-linear-to-br from-[#450af5] to-[#c4efd9] rounded-lg shadow-2xl flex items-center justify-center">

<div class="w-64 bg-[#0f0f0f] text-gray-200 h-screen flex flex-col">
    ...
    <div class="px-4 py-4 flex items-center justify-between">
        ...
        <button 
            wire:click="startCreatingPlaylist"
    ...
    <div class="overflow-y-auto scrollbar-hide flex-1 px-2">
        ...
        >
            ...
            <div class="min-w-0 flex-1">
                <input 
                    x-ref="newPlaylistInput"
                    type="text"
                    wire:model="newPlaylistName"
                    wire:keydown.enter="createPlaylist"
                    wire:keydown.escape="cancelCreatingPlaylist"
                    @blur="$wire.createPlaylist()"
        ...
        >
            ...
            <div class="min-w-0 flex-1">
                <input 
                    ...
                    wire:keydown.enter="updatePlaylistName"
                    wire:keydown.escape="cancelEditingPlaylist"
        ...
        <a href="{{ $item['route'] ?? '#' }}" wire:navigate
            @if(!empty($item['id']))
            x-data
            @contextmenu.prevent="$wire.startEditingPlaylist({{ $item['id'] }})"
            @endif
            ...
            <button 
                wire:click.prevent="deletePlaylist({{ $item['id'] }})"

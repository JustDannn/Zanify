<div class="sticky top-0 z-50">
        ...
        <div class="flex items-center gap-3 flex-1">
            ...
            <div class="relative flex-1 max-w-lg">
                ...
                @if(!empty($suggestions))
                    <div class="absolute mt-2 w-full bg-[#1c1c1c] rounded-xl shadow-xl border border-gray-800 animate-fadeIn z-50">
                        @foreach($suggestions as $item)
                            <div 
                                wire:click="selectSuggestion('{{ $item }}')"
            ...
            <button class="p-2 rounded-full hover:bg-gray-800 transition">
                <svg xmlns="http://www.w3.org/2000/svg" 
                    class="h-6 w-6 text-gray-300" fill="none"
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0" />
            ...
            <div class="relative group">
                <button class="flex items-center gap-2 hover:bg-gray-800 p-2 rounded-full transition">
                    <img src="/profile.jpg" class="w-8 h-8 rounded-full object-cover" />
                </button>

                {{-- DROPDOWN --}}
                <div class="hidden group-hover:block absolute right-0 mt-3 w-40 bg-[#1c1c1c] rounded-xl border border-gray-800 shadow-xl z-50">
